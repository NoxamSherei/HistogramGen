...
public class HistogramBenchmark {
    ...
    private HistogramProcessor<int, TestRecordObj> _histogramBuilder = new HistogramProcessorBuilder<int, TestRecordObj>().SetGetRangeKeyFunc(x => x.Start, x => x.End).Build();
